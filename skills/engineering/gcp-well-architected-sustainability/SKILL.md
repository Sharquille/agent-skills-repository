---
name: gcp-well-architected-sustainability
description: >-
  ...
  and manage the workload sustainably in Google Cloud. Note: "WAF" here means
  Well-Architected Framework, NOT Web Application Firewall.
# --- provenance (added on import; renamed google-cloud-waf-sustainability -> gcp-well-architected-sustainability to avoid the WAF/Web-Application-Firewall acronym collision) ---
category: engineering
source: https://github.com/google/skills/blob/main/skills/cloud/google-cloud-waf-sustainability/SKILL.md

...
source: https://skillrepo.dev/skills/addyosmani/frontend-ui-engineering
author: Addy Osmani
license: MIT
...
- Developing backend API routing, controller logic, or database management systems.
- Scripting system tasks, CLI tools, or cloud infrastructure operations.
- App-level network socket programming or transport-layer protocols.

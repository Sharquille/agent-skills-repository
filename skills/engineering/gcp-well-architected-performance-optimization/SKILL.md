---
name: gcp-well-architected-performance-optimization
description: >-
  ...
  elasticity. Note: "WAF" here means Well-Architected Framework, NOT Web
  Application Firewall.
# --- provenance (added on import; renamed google-cloud-waf-performance-optimization -> gcp-well-architected-performance-optimization to avoid the WAF/Web-Application-Firewall acronym collision) ---
category: engineering
source: https://github.com/google/skills/blob/main/skills/cloud/google-cloud-waf-performance-optimization/SKILL.md

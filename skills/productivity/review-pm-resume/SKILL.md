...
description: "Comprehensive PM resume review and tailoring against 10 best practices including XYZ+S formula, keyword optimization, job-specific tailoring, and structure. Use when reviewing a PM resume, preparing for job applications, or improving resume impact. Specific to Product Manager resumes — for other roles the PM-specific advice (XYZ+S, PM titles, frameworks) may not apply."
# --- provenance (added on import; renamed review-resume -> review-pm-resume for scope precision) ---
category: productivity
source: https://github.com/phuryn/pm-skills/tree/main/pm-toolkit/skills/review-resume
...
If `$RESUME` is empty, ask the user to paste their resume text (or share a file) before proceeding — there is nothing to review without it.
